...
const Register: React.FC = () => {
  ...
  return (
    ...
    >
        ...
        <div className="w-full max-w-5xl mx-auto px-6 grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-7">
            <div className="text-center md:text-left mb-2">
              <h1 className="text-3xl md:text-4xl font-bold mb-2 inline-block bg-white/30 backdrop-blur-sm px-4 py-2 rounded-lg shadow-sm">
                <span className="text-amber-950">Register </span>
                <span className="text-amber-800">Your Company</span>
              </h1>
              <p className="text-base font-medium bg-white/40 backdrop-blur-sm px-4 py-2 rounded-lg text-amber-950 shadow-sm mt-1 inline-block">
                Create your company account to start building trusted verification chains for your customers.
              </p>
            </div>

            {/* Registration Form */}
            <div className="bg-gradient-to-br from-amber-300/40 via-amber-200/30 to-orange-100/40 backdrop-blur-lg p-4 rounded-3xl shadow-lg border border-amber-100/40 relative overflow-hidden">
              ...
              <div className="relative z-10">
                {isSubmitted ? (
                  <div className="text-center py-6">
                    <div className="w-14 h-14 bg-amber-100/70 rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-amber-800 mb-3 text-sm">We've sent a verification email to your inbox. Please check and confirm your email to activate your account.</p>
                    <Link 
                      to="/" 
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        type="text"
                        className={`w-full px-3 py-2 rounded-lg bg-white/80 backdrop-blur-sm border ${
                      ...
                      />
                      {errors.companyName && (
                        <p className="text-error-red text-xs mt-1">{errors.companyName.message}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      />
                      {errors.email && (
                        <p className="text-error-red text-xs mt-1">{errors.email.message}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      />
                      {errors.password && (
                        <p className="text-error-red text-xs mt-1">{errors.password.message}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {errors.confirmPassword && (
                        <p className="text-error-red text-xs mt-1">{errors.confirmPassword.message}</p>
                      )}
                    </div>
                    ...
                    <div className="pt-1">
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className={`w-full bg-gradient-to-r from-amber-500 to-amber-700 text-white py-2 px-10 rounded-full font-semibold shadow-lg hover:shadow-amber-400/20 transition-all duration-300 ${
      ...
      {/* Footer */}
      <footer className="border-t border-amber-200/30 py-3 px-6 md:px-10 bg-amber-50/40 backdrop-blur-sm relative z-10 mt-1">
        <div className="container mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <p className="text-amber-800 text-xs mb-2 sm:mb-0">
