...
const Login: React.FC = () => {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      if (data.email.includes('@company') && data.password.length >= 8) {
        navigate('/dashboard');
      } else {
  ...
  return (
    <Layout>
      <div className="flex-grow flex flex-col items-center justify-center px-4">
        <h1 className="text-deep-blue text-4xl font-bold mb-2">Welcome Back</h1>
        <p className="text-gray-600 mb-8">Log in to manage your channels</p>
          ...
          <div className="bg-white p-6 rounded-lg">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-sm">
                New here? <Link to="/signup" className="text-gradient-start font-medium">Sign up</Link>
              </p>
            </div>
          </div>
        </form>
